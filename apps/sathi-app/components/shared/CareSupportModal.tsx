...
const CareSupportModal: React.FC<CareSupportModalProps> = ({
    visible,
    onClose,
    emailSubject = 'Sathi Network Companion Support',
}) => {
    ...
    const handleSendEmail = () => {
        const mailUrl = `mailto:info@maihoonna.com?subject=${encodeURIComponent(emailSubject)}`;
    ...
    const INFO_ROWS: { icon: keyof typeof Ionicons.glyphMap; label: string; value: string; color: string }[] = [
        ...
        { icon: 'time-outline', label: 'Hours', value: 'Mon–Sat, 9:00 AM – 7:00 PM IST', color: '#3B82F6' },
            ...
            <View style={styles.backdrop}>
                ...
                >
                    ...
                    >
                        ...
                        <Text style={styles.headerTitle}>Sathi Care Support</Text>
                        <Text style={styles.headerSubtitle}>
                            Need assistance with your companion visits,{'\n'}earnings, or verification?
                        </Text>
                    </LinearGradient>
